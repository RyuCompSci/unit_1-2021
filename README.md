...
| Description                                                              | Type                       | Input                                                                                                                                 | Expected Output                                                                                                                                                             | Success Criteria |
|--------------------------------------------------------------------------|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| Testing if the player's cards and the dealer's cards are shown properly. | Unit Testing (Function)    | N/A (Auto) (black_jack_2.py)                                                                                                          | ┌────┐ │Q       │ │        │ │        │ │   ♠    │ │        │ │        │ │       Q│x2 └────┘             with a random rank of card             from A to K and random suit | 1,6              |
| Testing if description of Blackjack is shown when type "y"               | Unit Testing (Function)    | N/A (Auto) (black_jack_2.py)                                                                                                          | Descriptionof the rules is shown                                                                                                                                            | 5,6              |
| Testing if the time played is properly saved in database.txt             | Unit Testing (Function)    | 1. Player's name 2. "n" 3. Type "y" until the score reaches 17 (If it goes over 21, repeat 1-3) 4. Type "n" when the score reaches 17 | Time played is in database.txt                                                                                                                                              | 2                |
| Testing if the player's name and score is saved in database.txt          | Unit Testing (Function)    | 1. Player's name 2. "n" 3, Type "y" until the score reaches 17 (If it goes over 21, repeat 1-3) 4. Type "n" when the score reaches 17 | Player's name and score is saved together  with time played in database.txt                                                                                                 | 3                |
| Testing coefficiency of the code blocks as entity                        | Integration (Function)     | 1. Player's name 2. "n" 3. Type "y" until the score reaches 17 (If it goes over 21, repeat 1-3) 4. Type "n" when the score reaches 17 | No bugs and typos                                                                                                                                                           | -                 |
